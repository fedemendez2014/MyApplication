 ...
 * {@link FragmentHomeCliente.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class FragmentHomeCliente extends Fragment {

    private OnFragmentInteractionListener mListener;

    public FragmentHomeCliente() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_home_cliente, container, false);
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentConfirmarCliente fragment = new FragmentConfirmarCliente();
                Bundle args = new Bundle();
                TextView txt = (TextView)getActivity().findViewById(
                        R.id.textView2);
                String fecha = txt.getText().toString();
